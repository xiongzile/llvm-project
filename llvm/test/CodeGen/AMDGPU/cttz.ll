...
; GFX10-GISEL-NEXT:    s_ff1_i32_b32 s2, s2
...
; GFX10-GISEL-NEXT:    v_ffbl_b32_e32 v3, v3
; GFX10-GISEL-NEXT:    v_min_u32_e32 v0, 32, v0
; GFX10-GISEL-NEXT:    v_min_u32_e32 v1, 32, v1
...
; GFX10-GISEL-NEXT:    s_bitset1_b32 s2, 8
; GFX10-GISEL-NEXT:    s_ff1_i32_b32 s2, s2
...
; SI-NEXT:    s_mov_b32 s2, -1
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_ff1_i32_b64 s4, s[6:7]
...
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    s_ff1_i32_b64 s4, s[6:7]
...
; GFX10-NEXT:    v_mov_b32_e32 v1, 0
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_ff1_i32_b64 s0, s[0:1]
...
; SI-NEXT:    s_waitcnt vmcnt(0)
; SI-NEXT:    v_ffbl_b32_e32 v3, v3
; SI-NEXT:    v_min_u32_e32 v3, 0xffffffdf, v3
; SI-NEXT:    v_add_i32_e32 v3, vcc, 32, v3
; SI-NEXT:    v_ffbl_b32_e32 v2, v2
...
; VI-NEXT:    s_waitcnt vmcnt(0)
; VI-NEXT:    v_ffbl_b32_e32 v1, v1
; VI-NEXT:    v_add_u32_e64 v1, s[0:1], v1, 32 clamp
; VI-NEXT:    v_ffbl_b32_e32 v0, v0
...
; SI-NEXT:    v_ffbl_b32_e32 v3, v3
; SI-NEXT:    v_min3_u32 v0, v3, v0, 64
...
; VI-NEXT:    v_ffbl_b32_e32 v1, v1
; VI-NEXT:    v_min3_u32 v0, v1, v0, 64
